                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    <img src="images/SKI.PNG" alt="Logo" width="40" height="15">
                                        <i class=""></i>
                                    </div>
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text"><span class="count"><?php echo $count_today_vehentries;?></span></div>
                                            <div class="stat-heading">Todays Participant Entries</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <img src="images/SKI.PNG" alt="Logo" width="40" height="15">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            ...
                                            <div class="stat-heading">Yesterdays Participant Entries</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <img src="images/SKI.PNG" alt="Logo" width="40" height="15">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            ...
                                            <div class="stat-heading">Last 7 days Participant Entries</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <img src="images/SKI.PNG" alt="Logo" width="40" height="15">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            ...
                                            <div class="stat-heading">Total Participant Entries</div>
                                        </div>
                                    </div>
                                </div>
                            </div>

...
if(isset($_POST['submit']))
  {
    $partnumb=mt_rand(100000000, 999999999);
    $skicatename=$_POST['skicatename'];
     $skicoun=$_POST['skicoun'];
    $vehreno=$_POST['vehreno'];
    $parname=$_POST['parname'];
    $partconnumb=$_POST['partconnumb'];
    $enteringtime=$_POST['enteringtime'];
    
     
    $query=mysqli_query($con, "insert into  tblvehicle(ParticipantNumber,SkiCategory,SkiCountry,RegistrationNumber,ParticipantName,ParticipantContactNumber) value('$partnumb','$skicatename','$skicoun','$vehreno','$parname','$partconnumb')");
    if ($query) {
...
<head>
    ...
    <title>VPMS - Add Participant</title>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="add-vehicle.php">Participant</a></li>
    ...
    echo $msg;
              ...
              ?>    
                  ...
                  <?php } ?> 
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Participant </label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="vehcomp" name="vehcomp" class="form-control" placeholder="Participant" required="true"></div>
                                    </div>                                
                                     <div class="row form-group">
